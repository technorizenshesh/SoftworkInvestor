...
import com.softworkinvestor.databinding.FragmentHomeBinding;
 ...
 */
public class HomeFragment extends Fragment implements MonthlyIncomeClick {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        monthlyIncomeAdapter = new MonthlyIncome(getActivity(),monthlyList, HomeFragment.this);
        ...
        binding.textViewNext.setOnClickListener(v ->
                {
                    ...
                    else
                    {
                        ...
                        bundle.putString("monthlyIncome",monthlyList.get(selectedPosition).getIncome());
                        Navigation.findNavController(v).navigate(R.id.action_navigation_home_to_investmentAmountFragment,bundle);
                    }
                }
                );
